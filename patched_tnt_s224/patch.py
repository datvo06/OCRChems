...
bms_image_data_dir = '/home/khanhdtq/kaggle/data'
...
def run_make_patch_data(mode='train'):
    ...
    dump_dir = f'/ext_data2/comvis/khanhdtq/bms/{mode}_patch16_s{pixel_scale:0.3f}'
    ...
    for i,d in df.iterrows():
        ...
        image_file = bms_image_data_dir + '/%s/%s/%s/%s/%s.png' % (mode, image_id[0], image_id[1], image_id[2], image_id)
    ...
    df_patch.to_csv(data_dir + f'/df_{mode}_patch_{pixel_scale:0.3f}.csv', index=False)
    exit(0)
